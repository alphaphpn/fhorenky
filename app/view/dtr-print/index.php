...
?>
	...
	<section>
		<div class="container-fluid">
			<div class="row">
				<!-- DTR- COA Copy Start -->
				<div class="col border border-secondary border-dashed">
					<div>
						...
						<table class="table" border="2">
							<thead>
								...
								<tr align="center">
									<th colspan="10" class="p-0 font-size-12"><b><?php echo trim(strtoupper($empnamek)); ?></b></th>
								</tr>
								<tr align="center">
				...
				<div class="col border border-secondary border-dashed">
					<div>
						...
						<table class="table" border="2">
							<thead>
								<tr>
									<th colspan="5" class="p-0 font-size-10">CIVIL SERVICE FORM No. 48</th>
									<th colspan="5" class="p-0 font-size-8 text-center">
										<div class="d-flex">
											<div class="flex-fill bg-secondary text-light">HR Copy</div>
										</div>
	...
	<section class="mt-5">
		<div class="container-fluid">
			<div class="row">
						...
						<table class="table" border="2">
							<thead>
								<tr>
									...
									<th colspan="4" class="p-0 font-size-10 text-center">
										<div class="d-flex">
											<div class="flex-fill bg-secondary text-light">Employee Copy</div>
										</div>
				...
				<!-- DTR- Employee Copy End -->

				<!-- DTR 3 Attendance In-Charge Copy Start -->
				<div class="col">
					<div>
						<div class="d-flex justify-content-between">
							<label class="font-size-10">BioTag: <?php echo trim($biolocationk); ?></label>
						...
						<table class="table" border="2">
							<thead>
								<tr>
									...
									<th colspan="3" class="p-0 font-size-10 text-center">
										<div class="d-flex">
											<div class="flex-fill bg-secondary text-light">Attendance In-Charge Copy</div>
										</div>
				...
				<!-- DTR 3 Attendance In-Charge Copy End -->
